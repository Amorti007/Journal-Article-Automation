<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl leading-tight" style="color: var(--text-primary);">
            {{ __('Yeni Sayı (Issue) Ekle') }}
        </h2>
    </x-slot>

        <div class="py-12" style="padding-top: 3rem; padding-bottom: 3rem;">
            <div class="bg-white rounded-xl shadow-md border" style="max-width: 35rem; margin: 0 auto; padding: 2.5rem;"> 
                <div class="mb-6">
